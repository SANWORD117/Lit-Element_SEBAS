...
import campanaStyles from './Styles/campanaStyles'

export class CampanaElement extends LitElement {
...
customElements.define('campana-element', CampanaElement);